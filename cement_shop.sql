...
-- Table: expenses (Stores daily expenses, added to fix the error)
...
-- Insert sample expenses (added for testing expenses.php)
INSERT INTO expenses (expense_name, amount, expense_date) VALUES 
('Office Supplies', 1500.00, '2025-05-27'),
('Electricity Bill', 3000.00, '2025-05-26'),
('Transport', 500.00, '2025-05-25');
