<?php
if (!isset($purchase) || !isset($items)) {
    die("Invalid invoice data.");
}
$shopName = "Cement Shop"; // Replace with your shop name
$shopAddress = "123 Builder Street, Construction City"; // Replace with your shop address
$invoiceDate = date('Y-m-d H:i:s', strtotime($purchase['purchase_date'] . ' ' . date('H:i:s')));
?>

<!DOCTYPE html>
<html>
<head>
    <title>Invoice - <?php echo htmlspecialchars($purchase['invoice_number']); ?></title>
    <style>
        body {
...
<body>
    <div class="invoice">
        <div class="invoice-header">
            ...
            <h2>Buy Invoice</h2>
            <p>Invoice No: <?php echo htmlspecialchars($purchase['invoice_number']); ?></p>
        ...
        <div class="invoice-details">
            ...
            <p><strong>Payment Method:</strong> <?php echo htmlspecialchars($purchase['payment_method_id'] ? 'Cash' : 'Other'); ?></p>
        </div>
